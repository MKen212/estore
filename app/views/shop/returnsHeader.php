<div class="row shopper-info"><!--returns_header_SHOP-->
  <div class="col-sm-4"><!--returns_information-->
    ...
    <table class="table table-sm">
      ...
      <tr><td>Invoice ID:</td><td><?= $returnDetails["InvoiceID"] ?></td></tr>
  ...
  <div class="col-sm-4"><!--shipping_information-->
    ...
    <table class="table table-sm">
      <tr><td colspan="2">Returned goods should be packaged securely and sent to the address below.</td></tr>
      <tr><td>Returns Address:</td><td><?= commaToBR(DEFAULTS["returnsAddress"]); ?></td></tr>
      <tr><td colspan="2">Please include the '<b>Returns Ref</b>' code on the label.</td></tr>
    </table>
