          ...
          <div class="col-sm-4 col-sm-offset-1" style="margin-bottom:50px">
            <div class="signup-form">
              <form action="" method="post" name="userForm" autocomplete="off">
                ...
                <input type="email" name="email" id="email" placeholder="Update Email Address" value="<?= $userRecord["Email"] ?>" required />
                <!-- Password -->
                <label for="password">Password:</label>
                <input type="password" name="password" id="password" minlength="5" placeholder="Update Password" />
                <!-- Name -->
                <label for="name">Name:</label>
                <input type="text" name="name" id="name" placeholder="Update Name" value="<?= $userRecord["Name"] ?>" required />
                <!-- Submit Button -->
