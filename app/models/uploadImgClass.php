...
class UploadImg {
  ...
  /**
   * addProductImg function - Add Product Image File to Server
   * @param int    $productID  Product ID for Image File
   * @param string $imgFilename  Filename for Image File
   * @return bool  True if success or False
   */
  public function addProductImg($productID, $imgFilename) {
    try {
      $tmpFile = $_FILES["imgFilename"]["tmp_name"];
