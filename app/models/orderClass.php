...
Class Order {
  ...
  /**
   * getRefData function - Returns the OwnerUserID, InvoiceID, PaymentID & Status for the specific OrderID using ord_paypal_view
   * @param int $orderID    Order ID for specific order
   * @return array $result  OwnerUserID, InvoiceID, PaymentID & Status for OrderID or False
   */
